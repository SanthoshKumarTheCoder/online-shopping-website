...
function ListWatches({ id, name, price, image, price_1, description, category, selectedCategory  }) {
      ...
      <div className='list-item'>
        <div>
          <div className='main-1'>
            <img className='item-img main_img-3' src={url+"/images/"+image} alt={name} onClick={handleItemClick} />
            ...
            <div className='add-card-2'onClick={handleItemClick}>
